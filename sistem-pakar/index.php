...
<head>
    ...
    <link rel="icon" href="image/logo-himatif.png">
    ...
    <main role="main">
        ...
        <div class="carousel-inner">
          <div class="carousel-item active">
            <img src="image/bg-utm.jpg" class="img-fluid" style="filter: brightness(50%); width: 100%;" alt="Responsive image">
            <div class="container">
              <div class="carousel-caption text-center">
                <h1>Sistem Pakar Jenis Olahraga Berdasarkan Kegiatan</h1>
                <p>Tentukan Jenis Olahraga apa yang harus anda tekuni berdasarkan kebutuhan anda.</p>
                <p><button type="button" class="btn btn-lg btn-primary" data-target="#exampleModal" data-toggle="modal" data-whatever="@getbootstrap">Mulai</button></p>
              </div>
            </div>
          </div>
