        ...
        <div class="card text-white bg-info mb-3">
          ...
          <div class="card-body text-left ukuran-30 ">
            ...
            <form method="post" action="solusi.php" enctype="multipart/form-data" role="form">
              ...
              function myFunction() {
                ...
                if ($row['kode_solusi']=="x-1" || $row['isi_solusi']=="x-2" || $row['isi_solusi']=="x-3" || $row['isi_solusi']=="x-4" || $row['isi_solusi']=="x-5") {
                    ...
                    echo "<p>Maka kamu harus melakukan Olahraga : <strong style='color:red'>".$row['isi_solusi']."</strong></p>";
                }
            ...
            <div class="text-center">
                ...
                <a style="margin-bottom: 10px;"  onclick="myFunction()" class="btn btn-outline-dark col-sm-2">Cetak</a>
            </div>
          </div>
